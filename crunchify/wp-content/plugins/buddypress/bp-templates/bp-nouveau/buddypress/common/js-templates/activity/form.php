...
<script type="text/html" id="tmpl-activity-post-form-avatar">
	<# if ( data.display_avatar ) { #>
		<a href="{{data.user_domain}}">
			<img class="avatars" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ8rol7JqhyiG7KG49RQOrv0VacN4sfYWaWRQ&usqp=CAU" class="avatar user-{{data.user_id}}-avatar avatar-{{data.avatar_width}} photo" width="{{data.avatar_width}}" height="{{data.avatar_width}}" alt="{{data.avatar_alt}}" />
		</a>
	<# } #>
</script>
